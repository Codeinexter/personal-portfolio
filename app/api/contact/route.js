...
// HTML email template
const generateEmailTemplate = (name, email, subject, userMessage) => `
...
async function sendEmail(payload, subject, message) {
  ...
  const mailOptions = {
    ...
    subject: subject, 
    text: message, 
    html: generateEmailTemplate(name, email, userSubject, userMessage), 
    replyTo: email, 
  };
